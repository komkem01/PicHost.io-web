    ...
    <div class="flex-1 flex items-center justify-center px-4 py-12 pt-[88px]">
      <div class="w-full max-w-[400px]">
        ...
        <div class="text-center mb-8">
          <h1 class="text-[28px] font-bold tracking-tight text-white mb-1.5">{{ $t('auth.login.title') }}</h1>
          <p class="text-[14px] text-white/40">{{ $t('auth.login.subtitle') }}</p>
        </div>
        ...
        <div class="relative rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-xl shadow-2xl shadow-black/60 p-7">
          ...
          <form @submit.prevent="handleSubmit" novalidate class="space-y-4">
            <!-- Email -->
            <div>
              <label for="email" class="block text-[12.5px] font-medium text-white/50 mb-1.5">{{ $t('auth.login.emailLabel') }}</label>
              <div class="relative">
                <input
                  id="email"
                  v-model="form.email"
            ...
            <div>
              <div class="flex items-center justify-between mb-1.5">
                <label for="password" class="block text-[12.5px] font-medium text-white/50">{{ $t('auth.login.passwordLabel') }}</label>
                <NuxtLink to="/auth/forgot-password" class="text-[11.5px] text-blue-400 hover:text-blue-300 transition-colors">
